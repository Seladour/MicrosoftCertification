                ...
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 2] == "Age: ?")
                    {
                        do
                        {
                            ...
                            validAge = int.TryParse(readResult, out parsedAge);
                        }
                        while (!validAge);
                    ...
                    if (string.IsNullOrEmpty(ourAnimals[i, 4].Substring(22)))
                    {
                        do
                        {
                            Console.WriteLine($"Enter a physical description for {ourAnimals[i, 0]} (size, colour, breed, gender, weight, housebroken)");
                            readResult = Console.ReadLine();
